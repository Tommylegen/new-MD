...
_sewa.expiredCheck(danzz, sewa)
	...
	if (db.data.settings[botNumber].autobio) {
		...
		await danzz.setStatus(`${'©Patrick-MD'} | Runtime : ${runtime(process.uptime())}`)
...
Hi saya ${namabot}, bot whatsapp yang dibuat oleh:RajaDev, pada 21/08/22 menggunakan JavaScript.

*Sosmed*
- My Tiktok:
https://tiktok.com/@tommylegends2
- My Youtube:
https://youtube.com/channel/UCxVf6aARpoMp8w6vh9MKARQ
- My Instagram:
Lupa anying_-
- My Facebook:
Ga ada`
                let btn = [{
                                ...
                                urlButton: {
                                    ...
                                    url: 'https://rajadev-api.herokuapp.com/'
                                }
                            }, {
                                quickReplyButton: {
                                    displayText: 'Donasi',
...
contoh : https://rajadevcodingweb.barux2022.tk
`
            ...
            case 'yts': case 'ytsearch': {
                if (!text) throw `Example : ${prefix + command} RajaDev`
		...
		case 'deletevote': case'delvote': case 'hapusvote': {
            ...
            case 'antilink': {
             ...
             case 'mute': {
                ...
                m.reply(`${'© RajaDev'} telah di mute di group ini !`)
                } else if (args[0] === "off") {
                if (!db.data.chats[m.chat].mute) return m.reply(`Sudah Tidak Aktif Sebelumnya`)
                db.data.chats[m.chat].mute = false
                m.reply(`${'© RajaDev'} telah di unmute di group ini !`)
                } else {
                 let buttons = [
                        { buttonId: 'mute on', buttonText: { displayText: 'On' }, type: 1 },
                        { buttonId: 'mute off', buttonText: { displayText: 'Off' }, type: 1 }
                    ]
                    await danzz.sendButtonText(m.chat, buttons, `Mute Bot`, '© RajaDev', m)
                }
             }
             break
            ...
            case 'ephemeral': {
                ...
                danzz.sendListMsg(m.chat, `Please select the following Ephemeral Options List !`, '© RajaDev', `Hello Admin ${groupMetadata.subject}`, `Click Here`, sections, m)
                }
            }
            break
            //OWNER MENU
            ...
            case 'bcgc': case 'bcgroup': {
                ...
                for (let i of anu) {
                    ...
                    let btn = [{
                      ...
                      danzz.send5ButImg(i, txt, '© RajaDev', global.thumb, btn)
                    }
...
Minat? wa.me/6289505054287?text=bang+mau+sewabot
...
*Penyedia Rest Api* :
- https://zenzapis.xyz
- https://rajadev-api.herokuapp.com/`
	let btn = [{
                                urlButton: {
                                    displayText: 'Youtube',
                                    url: 'https://youtube.com/channel/UCxVf6aARpoMp8w6vh9MKARQ'
...
case 'qrisallpay': {
            ...
            break
case 'dana': {
 m.reply('DANA : 089505054287')
}
break
case 'gopay': {
 m.reply('GOPAY : 089505054287')
}
break
case 'pulsa': {
m.reply('PULSA : 089512810601')
}
break
            default:
                if (budy.startsWith('=>')) {
